...
private _markerTitle = call {
    ...
    if (_originalName in resourcesX) exitWith {
        ...
        if (PCF_EnableResourceUpgrade) then {
            ...
            format ["%1- L%2 ", format [localize "STR_resources", _nearestCityName], _upgradeLevel]
        } else {
            format [localize "STR_resources", _nearestCityName]
        };
    };
    ...
    if (_marker in factories) exitWith {
        ...
        if (PCF_EnableResourceUpgrade) then {
            ...
            format ["%1- L%2 ", format [localize "STR_factory", _nearestCityName], _upgradeLevel]
        } else {
            format [localize "STR_factory", _nearestCityName]
        };
    };
