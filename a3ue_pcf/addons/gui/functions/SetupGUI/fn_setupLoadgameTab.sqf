...
/*PCF Extended Traits checkbox display, check the end of "case "Start Game"" around line 243, too.
Disabled in favor bool of parameter dropbox option, kept till checkbox paramter option is tried.
Re-add "#define A3A_IDC_SETUP_TRAITSCHECKBOX 6132" to "ids.inc" when used again.
Also add the setupDialog.hpp config when used again.*/

//private _TraitsCtrl = _display displayCtrl A3A_IDC_SETUP_TRAITSCHECKBOX; //Disabled in favor bool of parameter dropbox option, kept till checkbox paramter option is tried.
...
switch (_mode) do
{
    ...
    case ("startGame"):
    {
        ...
        //PCF Extended Traits checkbox display and global variable definiton for access during mission. Check "Get Display" at the beginning of the file, too.
        //Disabled in favor bool of parameter dropbox option, kept till checkbox paramter option is tried.
        //Re-add "#define A3A_IDC_SETUP_TRAITSCHECKBOX 6132" to "ids.inc" when used again.
        //Also add the setupDialog.hpp config when used again.
        //_TraitsCBState = cbChecked _TraitsCtrl;
        //missionNamespace setVariable ["A3UE_PCF_ExtendedTraits", _TraitsCBState];
